        ...
        <x-drawer id="campaignDrawer" overlayId="campaignOverlay" title="Edit Campaign" :submit-on-click="'saveCampaignForm()'" :submit-btn-text="'Update Campaign'">
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <img x-show="editForm.banner_preview" :src="editForm.banner_preview" alt="Current banner" class="w-32 h-20 object-cover rounded border mb-2">
                    <input x-ref="bannerInput" @change="editForm.banner_image = $event.target.files[0]" type="file" accept="image/jpeg,image/png,image/webp" class="w-full rounded border-gray-300">
                </div>
            </div>
        </x-drawer>
    </div>

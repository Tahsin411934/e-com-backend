    ...
    public function getAnnouncementBarDataTable(Request $request)
    {
        ...
        return DataTables::of($query)
            ...
            ->addColumn('action', function (AnnouncementBar $bar) {
                $editBtn = '<button class="js-crud-action btn-primary px-2 py-1 rounded text-sm mr-2" data-crud-action="edit" data-crud-callback="announcement_barEdit" data-crud-id="'.$bar->id.'" title="Edit"><i class="fa fa-pencil"></i></button>';

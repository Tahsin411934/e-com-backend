    ...
    public function getBannerDataTable(Request $request)
    {
        ...
        return DataTables::of($query)
            ...
            ->addColumn('action', function (Banner $banner) {
                $editBtn = '<button class="js-crud-action btn-primary px-2 py-1 rounded text-sm mr-2" data-crud-action="edit" data-crud-callback="bannerEdit" data-crud-id="'.$banner->id.'" title="Edit"><i class="fa fa-pencil"></i></button>';

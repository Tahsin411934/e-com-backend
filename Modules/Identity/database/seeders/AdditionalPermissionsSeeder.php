...
class AdditionalPermissionsSeeder extends Seeder
{
    ...
    private const MODULES = [
        ...
        'size_groups' => [
            'size-groups.view' => 'View size groups',
            'size-groups.create' => 'Create size groups',
            'size-groups.edit' => 'Edit size groups',
            'size-groups.delete' => 'Delete size groups',
        ],
        'tax_rates' => [
    ...
    private const ROLE_GRANTS = [
        'Admin' => [
            ...
            'units.*', 'sizes.*', 'size-groups.*', 'tax-rates.*', 'barcode-print.view',
        ...
        'Manager' => [
            ...
            'units.view', 'sizes.view', 'size-groups.view', 'barcode-print.view',
            'stores.view',

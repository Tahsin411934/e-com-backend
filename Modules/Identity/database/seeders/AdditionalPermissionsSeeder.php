...
class AdditionalPermissionsSeeder extends Seeder
{
    ...
    private const ROLE_GRANTS = [
        'Admin' => [
            ...
            'stores.create', 'stores.delete', 'store-staff.*', 'countries.*',
        ...
        'Manager' => [
            ...
            'deliveries.view', 'refunds.view',
            'pos.view', 'pos.sell', 'pos-registers.view', 'pos-sales.view',
            'reports.*', 'reviews.view',
        ],
        'Staff' => [
            'dashboard.view',
            'products.view', 'categories.view', 'brands.view',
            'inventory.view', 'orders.view', 'stores.view',
            'reports.view', 'pos.view', 'pos.sell',
        ],
        'Store Owner' => [
            'dashboard.view',
